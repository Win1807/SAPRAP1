...
@ObjectModel.representativeKey: 'subordinatePersonnelNumber'
@UI.headerInfo: {
    typeName: 'Subordinado',
    typeNamePlural: 'Subordinados'
}
// visualizations: [{ type: #AS_LINEITEM }],
//requestAtLeast: [ 'supervisorFunctionText' ],
@UI.presentationVariant: [{
    sortOrder: [{ by: 'supervisorPersonnelNumber', direction: #ASC  }, { by: 'subordinatePersonnelNumber', direction: #ASC}],
    groupBy: [ 'supervisorPersonnelNumber','supervisorFunctionText' ],
   visualizations: [{ type: #AS_LINEITEM }]
    
//    maxItems: 30
  }]
define custom entity ZC_HCM_MatrixReportTree
...
//        @UI.lineItem                : [{position: 10}]
  roleSignSuperiorSubordinate : zrsign;       // A o B superior/subordinado
//  @UI.hidden: true
//      @UI.lineItem                : [{position: 20}]
      @UI.lineItem                : [{position: 5}]
  supervisorPersonnelNumber   : zpernr_d;     // Cod persona superior
